...
// Main executes the mf program using the supplied arguments.
func Main(stdin io.Reader, stdout, stderr io.Writer) (mainErr error) {
	defer func() {
...
func opener(nm string) (io.Reader, error) { return knuth.Open(nm, nil) }
